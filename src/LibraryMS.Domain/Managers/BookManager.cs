...
public class BookManager: DomainService
	{
		...
		public async Task<Book> CreateAsync(string title, string author, DateOnly publishedDate, string isbn, string coverImagePath, int categoryId)
		{
		...
		public async Task<Book> UpdateAsync(int id, string title, string author, DateOnly publishedDate, string isbn, string coverImagePath, int categoryId)
		{
